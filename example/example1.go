...
// Параметри: Първият параметър е числото с плаваща запетая,
//            Вторият параметър е броя на цифрите след десетичната запетая
// Резултати: Първият резултат е цяло число преди десетичният знак,
//            Вторият е цяло число след десетичния знак закръглено съгласно втория параметър
